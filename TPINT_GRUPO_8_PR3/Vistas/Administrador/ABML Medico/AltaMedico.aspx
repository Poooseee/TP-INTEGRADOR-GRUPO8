<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AltaMedico.aspx.cs" Inherits="Vistas.Administrador.ABML_Paciente.AltaPaciente" %>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:Label ID="lblAltaPac" runat="server" Font-Bold="True" Font-Size="Medium" Text="ALTA de Medicos"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style3">Dias de atención:</td>
                    <td>
                        <asp:CheckBoxList ID="chkboxDiasAtencion" runat="server">
                        </asp:CheckBoxList>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style3">Baja:</td>
                    <td>
                        <asp:CheckBoxList ID="chkboxBaja" runat="server">
                        </asp:CheckBoxList>
                    </td>
                </tr>
                <tr>
